...
class ETMap {
    ...
    processMessage_settings(ws, d) {
        if(((d.v === "L2") || (d.v === "L3")) && d.t == "base") {
            ...
            this.settingsText(ws, d.v, d.i, d.text, d.height, d.depth, d.py, d.color, d.text_align, 
    ...
    settingsText(ws, view, id, text, height, depth, py, color, text_align, bg_type, bg_show, bg_color, border_show, border_color, border_width, bg_depth, rotation_x) {
        if((view !== "L2") && (view !== "L3")) {
            wsSendError(ws, "Invalid format");
            return;            
        }
        ...
        this.diagram[view].text[id].depth = depth;
