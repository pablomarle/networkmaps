...
class ETMap {
    ...
    processMessage_resize(ws, d) {
        if(d.v == "L2" && d.t == "base") {
            ...
            this.resizeL3Segment(ws, d.i, d.x, d.y, d.z);
        }
        else if(d.v == "L3" && d.t == "vrf") {
            this.resizeL3Vrf(ws, d.i, d.x, d.y, d.z);
        }
        else {
            this.logmessage("WS msg error.");
            ws.terminate();
    ...
    resizeL3Segment(ws, id, sx, sy, sz) {
        // Verify Parameters
        if (
                (! (typeof sx === "number")) ||
                (! (typeof sy === "number")) ||
        ...
        this.diagram.L3.l2segment[id].sx = sx;
        this.diagram.L3.l2segment[id].sy = sy;
        this.diagram.L3.l2segment[id].sz = sz;
    ...
    resizeL3Vrf(ws, id, sx, sy, sz) {
        ...
        this.diagram.L3.vrf[id].sx = sx;
        this.diagram.L3.vrf[id].sy = sy;
        this.diagram.L3.vrf[id].sz = sz;
