...
class ETMap {
    ...
    processMessage_settings(ws, msg_id, d) {
        if(((d.v === "L2") || (d.v === "L3")) && d.t == "base") {
            ...
            this.settingsLink(ws, msg_id, d.v, d.t, d.i, d.name, d.description, d.type, d.order, d.color, d.weight, d.height);
        }
    ...
    settingsLink(ws, msg_id, view, type, id, name, description, link_type, order, color, weight, height) {
        if (
                (! (typeof name === "string")) ||
                (name.length > 128) ||
                (! (typeof description === "string")) ||
