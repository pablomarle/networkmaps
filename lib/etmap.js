...
class ETMap {
    ...
    processMessage_settings(ws, d) {
        if(((d.v === "L2") || (d.v === "L3")) && d.t == "base") {
            this.settingsBase(ws, d.v, d.i, d.name, d.subtype, d.color1, d.color2, d.t1name, d.t2name, d.sy, d.tsx, d.tsy);
        }
        else if(d.v == "L2" && d.t == "device") {
    ...
    settingsBase(ws, view, id, name, subtype, color1, color2, t1name, t2name, sy, tsx, tsy) {
        // Check parameters
        if (
                (! (typeof name === "string")) ||
                (name.length > 128) ||
