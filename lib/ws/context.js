const UserMGT = require("../user/usermgt");
 ...
 * @property {UserMGT} usermgt - User management service
 * @property {Object} config - Application configuration
 * @property {Object} html - HTML template engine
...
class WSUserContext {
     ...
     * @param {UserMGT} usermgt - User management service
