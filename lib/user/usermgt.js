...
class UserMGT {
    constructor() {
        ...
        this.shapesPath = context.config.diagrams.shapes;
    ...
    /**
     * Function to get list of shapes owned by a user or public shapes
     * @param {str} sessionid - Session identifier
     * @returns {Object} Result object with list of shapes or error
     */
    listShapes(sessionid) {
        return shapeManager.listShapes(sessionid, this.data);
    }

    /**
     * This function creates a new shapegroup.
     */
    async newShape(sessionid, name, description, category) {
        return shapeManager.newShape(sessionid, name, description, category, this.data, this.shapesPath);
    }
    ...
    updateShapeShapes(sessionid, shape_key, shapes, callback) {
        ...
        let path = this.shapesPath + "/" + shape_key + "/definition.json";
    ...
    removeShapeTexture(sessionid, shapegroup_key, filename, callback) {
        ...
        let path = this.shapesPath + "/" + shapegroup_key + "/";
